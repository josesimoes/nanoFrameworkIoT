namespace System
{
    ...
    public readonly ref struct ReadOnlySpanByte
    {
        ...
        public ReadOnlySpanByte(byte[]? array)
        {
            _array = array;
        ...
        //
        // Summary:
        //     Creates a new System.ReadOnlySpan`1 object from a specified number of byte elements starting
        //     at a specified memory address.
        //
        // Parameters:
        //   pointer:
        //     A pointer to the starting address of a specified number of byte elements in memory.
        //
        //   length:
        //     The number of byte elements to be included in the System.ReadOnlySpan`1.
        //
        // Exceptions:
        //   T:System.ArgumentException:
        //     byte is a reference type or contains pointers and therefore cannot be stored in
        //     unmanaged memory.
        //
        //   T:System.ArgumentOutOfRangeException:
        //     length is negative.
        //[CLSCompliant(false)]
        //public ReadOnlySpanByte(void* pointer, int length);
        ...
        /// </exception>
        public ReadOnlySpanByte(byte[]? array, int start, int length)
        {
            if (array != null)
            {
        ...
        /// </summary>
        public static ReadOnlySpanByte Empty => new ReadOnlySpanByte();
        ...
        public ReadOnlySpanByte Slice(int start)
        {
            ...
            return new ReadOnlySpanByte(_array, start, Length - start);
        }
        ...
        public ReadOnlySpanByte Slice(int start, int length)
        {
            ...
            return new ReadOnlySpanByte(_array, start, length);
        }
