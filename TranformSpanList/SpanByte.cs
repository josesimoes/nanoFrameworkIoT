namespace System
{
    ...
    public readonly ref struct SpanByte
    {
        ...
        //
        // Summary:
        //     Creates a new System.Span`1 object from a specified number of byte elements starting
        ...
        //
        //   length:
        //     The number of byte elements to be included in the System.Span`1.
        //
        // Exceptions:
        ...
        //     length is negative.
        //[CLSCompliant(false)]
        //public SpanByte(void* pointer, int length);
        ...
        public SpanByte Slice(int start)
        {
            ...
            return new SpanByte(_array, start, Length - start);
        }
